...
OutputDir=x64
OutputBaseFilename=nunn64_setup_{#MyAppVersion}
SetupIconFile=
Compression=lzma
...
[Files]
Source: "x64\Release64\ocr_test.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: IsWin64;
Source: "x64\Release64\winttt.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: IsWin64;
Source: "x64\Release64\mnist_test.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: IsWin64;
Source: "x64\Release64\tictactoe.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: IsWin64;
Source: "x64\Release64\xor_test.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: IsWin64;
...
[Icons]
Name: "{group}\ocr_test"; Filename: "{app}\ocr_test.exe"
