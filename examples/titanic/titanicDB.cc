...
const Passenger titanicDB[] = {
    ...
    { 1, "Cardeza, Mrs. James Warburton Martinez (Charlotte Wardle Drake)", Female, 58, 0, 1,
        512.3292, 1 },
    ...
    { 1, "Crosby, Mrs. Edward Gifford (Catherine Elizabeth Halstead)", Female, 64, 1, 1, 26.5500,
        1 },
    ...
    { 1, "Frolicher-Stehli, Mrs. Maxmillian (Margaretha Emerentia Stehli)", Female, 48, 1, 1,
        79.2000, 1 },
    ...
    { 1, "Duff Gordon, Lady. (Lucille Christiana Sutherland) (Mrs Morgan)", Female, 48, 1, 0,
        39.6000, 1 },
    ...
    { 1, "Spedden, Mrs. Frederic Oakley (Margaretta Corning Stone)", Female, 40, 1, 1, 134.5000,
        1 },
    { 3, "Goodwin, Mr. Charles Frederick", Male, 40, 1, 6, 46.9000, 0 },
    { 2, "Brown, Mrs. Thomas William Solomon (Elizabeth Catherine Ford)", Female, 40, 1, 1, 39.0000,
        1 },
    ...
    { 3, "Andersson, Mrs. Anders Johan (Alfrida Konstantia Brogren)", Female, 39, 1, 5, 31.2750,
        0 },
    ...
    { 3, "Asplund, Mrs. Carl Oscar (Selma Augusta Emilia Johansson)", Female, 38, 1, 5, 31.3875,
        1 },
    ...
    { 3, "Dyker, Mrs. Adolf Fredrik (Anna Elisabeth Judith Andersson)", Female, 22, 1, 0, 13.9000,
        1 },
    ...
    { 2, "Phillips, Miss. Kate Florence (Mrs Kate Louise Phillips Marshall)", Female, 19, 0, 0,
        26.0000, 1 },
    ...
    { 1, "Marvin, Mrs. Daniel Warner (Mary Graham Carmichael Farquarson)", Female, 18, 1, 0,
        53.1000, 1 },
